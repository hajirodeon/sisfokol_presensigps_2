...
if ((isset($_GET['aksi']) && $_GET['aksi'] == 'simpan'))
	...
	//masukin ke database...
	mysqli_query($koneksi, "INSERT INTO barang_lokasi(kd, orang_kd, orang_kode, orang_nama, filex, postdate) VALUES ".
...
if ((isset($_GET['aksi']) && $_GET['aksi'] == 'simpan2'))
	...
	if (empty($e_isi))
		...
		{
		//update
		mysqli_query($koneksi, "UPDATE barang_lokasi SET status = '$e_isi' ".
						"WHERE kd = '$e_kd'");
...
if ((isset($_GET['aksi']) && $_GET['aksi'] == 'form'))
	...
	$qyuk = mysqli_query($koneksi, "SELECT * FROM barang_lokasi ".
...
if ((isset($_GET['aksi']) && $_GET['aksi'] == 'pmasuk'))
	...
	//update...
	mysqli_query($koneksi, "UPDATE barang_lokasi SET lat_x = '$latx', ".
					"lat_y = '$laty', ".
					"alamat = '$nil_tujuan' ".
					"WHERE kd = '$yuk_kd'");
