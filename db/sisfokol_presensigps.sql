...
--
-- Host: localhost
-- Waktu pembuatan: 05 Sep 2020 pada 15.59
...
('e4ea2f7dfb2e5c51e38998599e90afc2', 'admin', '14e1398817e2ff21d2268eb5e169de65');

-- --------------------------------------------------------

--
-- Struktur dari tabel `a_profil`
--
...
--
-- Dumping data untuk tabel `a_profil`
--

INSERT INTO `a_profil` (`kd`, `judul`, `postdate`, `lat_x`, `lat_y`, `alamat`, `telp`, `email`, `filex`, `alamat_googlemap`) VALUES
('e807f1fcf82d132f9bb018ca6738a19f', 'Sekolah XYZ', '2020-09-05 15:57:43', '-6.921731002730483', '110.20404785871506', 'Jl. Raya . . .', 'x', 'x', 'logo.jpg', 'Kendal');
...
--
-- Struktur dari tabel `orang_lokasi`
--
...
--
-- Dumping data untuk tabel `orang_lokasi`
--

INSERT INTO `orang_lokasi` (`kd`, `orang_kd`, `orang_kode`, `orang_nama`, `postdate`, `lat_x`, `lat_y`, `status`, `hardware_kode`, `alamat`) VALUES
('3bbcc717e264e2ff6efc425c8f5e5631', '378deca6c66b4c09f272176a56ff255f', '1', '1', '2019-12-20 11:41:43', 'xstrix6.9713002', '110.1508815', 'MASUK', 'd4c392546f73b392', 'Jl. Sunan Abinawa,  Kersan,  Tegorejo,  Kec. Pegandon,  Kabupaten Kendal,  Jawa Tengah 51357,  Indonesia'),
...
--
-- Struktur dari tabel `orang_rekap`
--
...
--
-- Dumping data untuk tabel `orang_rekap`
--
...
--
-- Indeks untuk tabel `orang_lokasi`
--
ALTER TABLE `orang_lokasi`
  ADD PRIMARY KEY (`kd`);

--
-- Indeks untuk tabel `orang_rekap`
--
